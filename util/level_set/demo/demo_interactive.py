...
def interactive_level_set(image_name, seg_name, seed_name):
    ...
    # down sample the images to save time
    ...
    iter_inner = 10
    iter_outer = 10
    mu   = 0.01/timestep   # coefficient of the distance regularization term R(phi)
    ...
    for n in range(iter_outer):
        ...
        phi = drlse_region_interaction(phi, seg, Pf, lmda, mu, alfa, beta, epsilon, timestep, iter_inner, potentialFunction)
